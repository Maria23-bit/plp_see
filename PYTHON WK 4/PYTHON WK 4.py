...
if __name__ == "__main__":
    ...
    while True:
        ...
        input_filename = input("\Enter the name of the file to read (e.g., 'input.txt'): ").strip()
        output_filename = input("Enter the name for the new file (e.g., 'output.txt'): ").strip()
        ...
        if success:
            ...
            retry = input("\nFile processing failed. Do you want to try again? (yes/no): ").lower()
            if retry != 'yes':
                break
